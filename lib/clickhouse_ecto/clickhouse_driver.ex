defmodule ClickhouseEcto.Driver do
  @moduledoc """
  ...
  alias ClickhouseEcto.QueryDriver
  ...
  def start_link(opts) do
    DBConnection.start_link(ClickhouseEcto.Protocol, opts)
  end
  ...
  @spec query(pid(), binary(), list, Keyword.t) ::
          {:ok, iodata(), ClickhouseEcto.Result.t}
  def query(conn, statement, params, opts \\ []) do
    DBConnection.prepare_execute(conn, %QueryDriver{name: "", statement: statement}, params, opts)
  end

  @spec query!(pid(), binary(), list, Keyword.t) ::
          {iodata(), ClickhouseEcto.Result.t}
  def query!(conn, statement, params, opts \\ []) do
    DBConnection.prepare_execute!(conn, %QueryDriver{name: "", statement: statement}, params, opts)
  end
